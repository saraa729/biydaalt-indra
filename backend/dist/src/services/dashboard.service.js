...
async function getManagementDashboard(role) {
    const [users, programs, classes, admissions, news, announcements, contacts, materials, attendances, grades, logs, recentAdmissions, recentNews, recentAnnouncements, recentContacts, recentLogs,] = await Promise.all([
        prisma.user.count(),
...
async function getAcademicDashboard(role) {
...
async function getContentDashboard(role) {
...
async function getTeachingDashboard(userId, role) {
...
async function getStudentDashboard(userId, role) {
