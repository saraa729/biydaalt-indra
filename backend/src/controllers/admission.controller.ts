import { admissionService, type AdmissionStatusValue } from "../services/admission.service.js";

function handleError(res: any, error: unknown) {
  const message = error instanceof Error ? error.message : "Unexpected error";

  const status =
    message === "Program not found." ? 404 : message === "Invalid id" ? 400 : 400;
...
function parseStatus(value: unknown): AdmissionStatusValue | undefined {
